 ...
 */
function orbisius_ctc_matata_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ctc_matata_parent_style';
    $parent_base_dir = 'matata';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ctc_matata_child_theme_enqueue_styles' );
