         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 pad0r">
               <div class="site-branding">
                  ...
                  <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">The Full Text</a></h1>
                  <?php else : ?>
...
<!-- #masthead -->
 ...
 /*
        ...
        <div id="primary" class="col-md-5 col-sm-4 newsticker">
           ...
           <?php } ?>  
			...
			<?php if (1 == $newslite_customizer_all_values['newslite-header-enable-date']) { ?>
                <div id="secondary" class="timer col-md-2 col-xs-12 col-sm-3 pad0r">
